...
export default function Perfil() {
  return (
    <div className="min-h-screen flex mt-8 flex-col">
      <div className="flex w-full space-x-16 align-center justify-center">
        <div className="bg-mercury h-60 w-1/4 p-2 rounded">
        ...
        <div className="bg-mercury rounded w-1/2 h-60 p-2 flex space-x-2">
          <div className="bg-white shadow-md p-4 rounded w-1/3 h-full flex flex-col space-y-4 overflow-hidden">
          ...
          <div className="bg-white shadow-md p-4 rounded w-2/3 h-full flex flex-col space-y-4 overflow-hidden">
      ...
      <div className="w-full h-96 flex items-center justify-center mt-4 mx-auto flex-col">
        <h1 className="text-2xl text-start font-semibold mb-4">Cursos</h1>
        <div className="bg-mercury w-[79.5%] rounded h-full"></div>
      </div>
    </div>
  );
}
